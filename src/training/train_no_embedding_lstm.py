...
from action_conditioned_no_embedding import (
    ActionConditionedNoEmbeddingLSTM,
)
...
def main():
    ...
    print("Training No-Embedding Action LSTM")
    ...
    model = ActionConditionedNoEmbeddingLSTM()
    ...
    torch.save(
        model.state_dict(),
        "data/processed/no_embedding_lstm.pt"
    )

    print("\nSaved no-embedding model")
